...
import {setErrorBlock, setLoading} from "./LoginSlice";
    ...
    return (<Container className=''>
        ...
        <Form onSubmit={handleSignUp}>
            ...
            <FormGroup>
                ...
                <FormControl autoComplete={'new-password'} required type="password" className="form-control-login" id="passId"
            ...
            <FormGroup>
                ...
                <FormControl autoComplete={'new-password'} required isInvalid={pass !== pass2} type="password" className="form-control-login" id="passId2"
